    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-gray-900 rounded-xl shadow-2xl w-full max-w-6xl h-[90vh] flex flex-col lg:flex-row">
        ...
        <div className="lg:hidden flex flex-col h-full">
          ...
          {/* Action Buttons - Prominently placed at top for mobile */}
          <div className="p-4 bg-gray-800 border-b border-gray-700">
            <div className="flex space-x-3">
              ...
              <button
                ...
                className="flex-1 bg-green-600 hover:bg-green-700 text-white rounded-lg py-3 px-4 text-sm font-medium transition-colors"
              >
                Apply Changes
              </button>
            </div>
          ...
          <div className="flex flex-col w-full">
            ...
            <div className="flex flex-1 overflow-hidden">
              ...
              <div className="w-80 bg-gray-900 border-l border-gray-700 flex flex-col">
                ...
                {/* Action Buttons - Moved to top of settings for desktop too */}
