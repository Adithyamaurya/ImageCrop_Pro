...
import { ZoomedCropCanvas } from './ZoomedCropCanvas';
...
export const AdvancedCropEditor: React.FC<AdvancedCropEditorProps> = ({
  ...
  const [showUncropped, setShowUncropped] = useState(false);
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-gray-900 rounded-xl shadow-2xl w-full max-w-7xl h-[95vh] flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-gray-700">
          <div className="flex items-center space-x-4">
            <h2 className="text-xl font-bold text-white">Pixel-Precise Crop Editor</h2>
        ...
        <div className="flex flex-1 overflow-hidden">
          {/* Main Canvas Area */}
          <div className="flex-1 bg-gray-800 flex flex-col p-4">
            {/* Zoomed Canvas with Size Indicator */}
            <ZoomedCropCanvas
              imageUrl={originalImage?.src || ''}
              originalImage={originalImage}
              crop={crop}
              onCropUpdate={onUpdateCrop}
            ...
            {/* Navigation Controls */}
            <div className="bg-gray-900 p-4 border-t border-gray-700 mt-4 rounded-lg">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-xs text-gray-400">
                      {Math.round(crop.width)} × {Math.round(crop.height)} pixels
                    </div>
                  </div>
                ...
                {/* Precision Info */}
                <div className="text-center">
                  <div className="text-xs text-gray-400">Pixel-Precise Editing</div>
                  <div className="text-sm text-blue-400">Zoom for 1:1 pixel accuracy</div>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        max="360"
                        step="0.1"
                        value={Number((crop.rotation || 0).toFixed(1))}
                        onChange={(e) => {
