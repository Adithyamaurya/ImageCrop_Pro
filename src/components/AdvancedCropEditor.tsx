...
import { X, Settings, ChevronLeft, ChevronRight, RotateCw, Download, Eye, EyeOff, Undo, ZoomIn, ZoomOut, RotateCcw, Check } from 'lucide-react';
...
export const AdvancedCropEditor: React.FC<AdvancedCropEditorProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className={`bg-gray-900 rounded-xl shadow-2xl w-full h-[90vh] flex flex-col ${
              ...
              <div className="flex bg-gray-700 rounded-lg p-1">
                <button
                  ...
                  className={`px-3 py-1 rounded text-sm transition-colors ${
                    mobileView === 'preview' ? 'bg-blue-600 text-white' : 'text-gray-300'
                  }`}
                >
                  Preview
                </button>
                <button
                  ...
                  className={`px-3 py-1 rounded text-sm transition-colors ${
                    mobileView === 'settings' ? 'bg-blue-600 text-white' : 'text-gray-300'
                  }`}
                >
                  Settings
                </button>
        ...
        {isMobile && (
          <div className="flex space-x-2 p-4 bg-gray-800 border-b border-gray-700">
            <button
              ...
              className={`flex-1 flex items-center justify-center space-x-2 rounded-lg py-3 px-4 text-sm font-medium transition-colors ${
                hasChanges 
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center space-x-2 bg-green-600 hover:bg-green-700 text-white rounded-lg py-3 px-4 text-sm font-medium transition-colors"
            >
        ...
        <div className={`flex flex-1 overflow-hidden ${isMobile ? 'flex-col' : ''}`}>
          ...
          <div className={`bg-gray-800 flex flex-col ${
              ...
              <div className="flex items-center justify-between p-3 bg-gray-700 border-b border-gray-600">
                <div className="flex items-center space-x-2">
                  <button
                    onClick={() => setShowUncropped(!showUncropped)}
                    className={`p-2 rounded-lg transition-colors ${
                      showUncropped ? 'bg-purple-600 text-white' : 'bg-gray-600 text-gray-300'
                    }`}
                    title="Toggle uncropped area preview"
                  >
                    {showUncropped ? <Eye className="h-4 w-4" /> : <EyeOff className="h-4 w-4" />}
                  ...
                  <button
                    onClick={() => setShowGrid(!showGrid)}
                    className={`p-2 rounded-lg transition-colors ${
                      showGrid ? 'bg-blue-600 text-white' : 'bg-gray-600 text-gray-300'
                    }`}
                    title="Toggle grid"
                  >
                    {showGrid ? <Eye className="h-4 w-4" /> : <EyeOff className="h-4 w-4" />}
            ...
            >
              ...
              {!isDragging && !isResizing && !isPanning && !isMobile && (
            ...
            {/* Crop Navigation Controls - Desktop Only */}
            {!isMobile && (
          ...
          <div className={`bg-gray-900 border-l border-gray-700 flex flex-col ${
            isMobile 
              ? (mobileView === 'settings' ? 'flex-1' : 'hidden')
              : 'w-80'
          }`}>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-6">
              ...
              {isMobile && (
                <div className="bg-gray-800 rounded-lg p-4">
                  <h4 className="text-sm font-semibold text-gray-300 mb-3">Crop Navigation</h4>
